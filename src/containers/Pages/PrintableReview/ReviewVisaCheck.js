...
const PaxVisaStatus = ({ paxVisaStatus: { firstName, lastName, visaFees } }) => (
        ...
        <div className="grid">
            ...
            <div className="gcell gcell--12 gcell--xs-5 gcell--sm-4">
                <div className="visa__right">
                    <span className="visa__text visa__text--md"><Trans id="cost"> Cost </Trans>:</span>
    ...
    return (
        <div className="visa__group">
            <div className="visa__head">
                <div className="visa__title visa__title--bold"><Trans id="e_visa"> E-VISA </Trans></div>
            </div>
            <div className="visa__body">
                {
                    passengers && passengers.map( (pax, i) => (
                        pax.status === "approved" && <PaxVisaStatus key={i} paxVisaStatus={pax} />
                    ))
                }
            </div>
        </div>
