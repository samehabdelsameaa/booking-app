...
class FlightBooking extends Component {
  render() {
    const {
      selectedFlights: { departureFlight, returnFlight },
      price,
      passengers
    } = this.props;
    ...
    return departureFlight && returnFlight ? (
      <div className="aside-flight">
        <div className="aside-title">
          ...
          <span>
            <Trans id="your_flight"> Your flight </Trans>
          </span>
        </div>
        <div className="aside__flight">
          <span className="aside__flight-point">
          ...
          <span className="aside__flight-point aside__flight-point--end">
        ...
        <div className="aside-flight__body">
          ...
          <div className="aside-visitors">
            ...
            <span>
              {paxCount && paxCount.adults > 0 ? paxCount.adults : null} {" "}
              { paxCount.adults ? <Trans id="adult"> Adult </Trans> : paxCount.adults > 1 ? <Trans id="adults"> Adults </Trans> : "1" }
            </span>
          </div>
          <div className="aside-cost">
            <span>
              <Trans id="cost_of_fly"> Cost of fly </Trans>:
            </span>
