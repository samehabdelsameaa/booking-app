...
const ReviewFlightReservation = ({ navigateTo, selectedFlight: { departureFlight, returnFlight } }) => {
                    ...
                    <div className="baggage open">
                        ...
                        <div className="baggage__content">
                            <div className="baggage__text _text-center">
                                <Trans id="your_baggage_allowance"> Your baggage allowance for international flights </Trans> – Guest <Trans id="class"> Class </Trans>
                            </div>
